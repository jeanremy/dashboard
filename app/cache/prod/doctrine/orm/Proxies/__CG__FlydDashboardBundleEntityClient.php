 ...
 */
class Client extends \Flyd\DashboardBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Flyd\\DashboardBundle\\Entity\\Client' . "\0" . 'type', '' . "\0" . 'Flyd\\DashboardBundle\\Entity\\Client' . "\0" . 'reminder', '' . "\0" . 'Flyd\\DashboardBundle\\Entity\\Client' . "\0" . 'needs', '' . "\0" . 'Flyd\\DashboardBundle\\Entity\\Client' . "\0" . 'codes', 'name', 'addresses', 'contacts', 'job', 'entrance', 'origin');
        }
     ...
     * {@inheritDoc}
     */
    public function addNeed(\Flyd\DashboardBundle\Entity\Need $need)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addNeed', array($need));

        return parent::addNeed($need);
    }

    /**
     * {@inheritDoc}
     */
    public function removeNeed(\Flyd\DashboardBundle\Entity\Need $need)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeNeed', array($need));

        return parent::removeNeed($need);
    }
    ...
    public function getNeeds()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNeeds', array());
    ...
    public function setCodes($codes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCodes', array($codes));

        return parent::setCodes($codes);
    }
