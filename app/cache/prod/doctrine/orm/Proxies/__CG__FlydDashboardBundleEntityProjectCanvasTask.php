 ...
 */
class ProjectCanvasTask extends \Flyd\DashboardBundle\Entity\ProjectCanvasTask implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Flyd\\DashboardBundle\\Entity\\ProjectCanvasTask' . "\0" . 'id', '' . "\0" . 'Flyd\\DashboardBundle\\Entity\\ProjectCanvasTask' . "\0" . 'position', '' . "\0" . 'Flyd\\DashboardBundle\\Entity\\ProjectCanvasTask' . "\0" . 'project_canvas', '' . "\0" . 'Flyd\\DashboardBundle\\Entity\\ProjectCanvasTask' . "\0" . 'task');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectCanvasTask $proxy) {
