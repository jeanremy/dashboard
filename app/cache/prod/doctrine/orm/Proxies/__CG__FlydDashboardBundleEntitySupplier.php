 ...
 */
class Supplier extends \Flyd\DashboardBundle\Entity\Supplier implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'addresses', 'contacts', 'job', 'entrance', 'origin');
        }
