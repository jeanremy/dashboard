 ...
 */
class User extends \Flyd\DashboardBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Flyd\\DashboardBundle\\Entity\\User' . "\0" . 'project_task_users', '' . "\0" . 'Flyd\\DashboardBundle\\Entity\\User' . "\0" . 'projects', '' . "\0" . 'Flyd\\DashboardBundle\\Entity\\User' . "\0" . 'image', '' . "\0" . 'Flyd\\DashboardBundle\\Entity\\User' . "\0" . 'job', '' . "\0" . 'Flyd\\DashboardBundle\\Entity\\User' . "\0" . 'file', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
     ...
     * {@inheritDoc}
     */
    public function setImage(\Flyd\DashboardBundle\Entity\Image $image = NULL)
    {
