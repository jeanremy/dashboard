...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FlydDashboardBundle', ($this->targetDirs[2].'/Resources/FlydDashboardBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FlydDashboardBundle', ($this->targetDirs[3].'/src/Flyd/DashboardBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Flyd/DashboardBundle/Entity'))), 'Flyd\\DashboardBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('FlydDashboardBundle' => 'Flyd\\DashboardBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_87f3382998a4e17f09e8a7a459843faa636477956c48ac6b0b6618f07bcd0240');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Flyd\\DashboardBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Flyd\\DashboardBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Flyd\\DashboardBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Flyd\\DashboardBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Flyd\\DashboardBundle\\Entity\\User');
    }
    ...
    protected function getImagine_ControllerService()
    {
        ...
        return $this->services['imagine.controller'] = $this->scopedServices['request']['imagine.controller'] = new \Avalanche\Bundle\ImagineBundle\Controller\ImagineController($this->get('request'), $this->get('imagine.cache.path.resolver'), $this->get('imagine.gd'), $this->get('imagine.filter.manager'), $this->get('filesystem'), ($this->targetDirs[2].'/../web'), ($this->targetDirs[2].'/../web'));
    }
    ...
    {
        $this->services['imagine.filter.manager'] = $instance = new \Avalanche\Bundle\ImagineBundle\Imagine\Filter\FilterManager(array('miniature' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 100, 1 => 100), 'mode' => 'outbound')), 'demi' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 75, 1 => 75), 'mode' => 'outbound')), 'small' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 46, 1 => 46), 'mode' => 'outbound'))));
    ...
    {
        return $this->services['imagine.routing.loader'] = new \Avalanche\Bundle\ImagineBundle\Routing\ImagineLoader('media/cache', array('miniature' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 100, 1 => 100), 'mode' => 'outbound')), 'demi' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 75, 1 => 75), 'mode' => 'outbound')), 'small' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 46, 1 => 46), 'mode' => 'outbound'))));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FlydDashboardBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Flyd/DashboardBundle/Resources/views'), 'FlydDashboard');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FlydDashboardBundle' => 'Flyd\\DashboardBundle\\FlydDashboardBundle',
            ...
            'fos_user.model.user.class' => 'Flyd\\DashboardBundle\\Entity\\User',
